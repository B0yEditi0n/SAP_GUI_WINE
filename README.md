...
- Caso aconteça o Bug do "Gosting window", onde uma janela do sap apos ser alternada ou minimizada deixa um rastro de borda soubre outra aplicação tente isso (no meu caso o bug aconteceu no cinnamon).
